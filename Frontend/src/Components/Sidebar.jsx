    ...
    <div className="w-80 min-w-80 bg-gray-800/50 backdrop-blur-xl border-r border-gray-700/50 flex flex-col overflow-y-auto custom-scrollbar h-full">
      ...
      {model && !isLoading && (
        <MaterialsList 
          ...
          isModelSelected={!!selectedModelId} // Add this
          currentTransformMode={transformMode} // Add this
        />
      )}
              ...
              <div className="mb-3 p-3 bg-gray-700/30 rounded-lg">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Apply all changes to geometry</p>
                  </div>
                  <button 
              ...
              <div className="mb-3 p-2 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs text-blue-400">
                    {models.length === 1 
                      ? `Will export: ${models[0].fileName}`
                      : `Will export all ${models.filter(m => m.visible !== false).length} visible models`
                    }
                  </p>
                </div>
                <p className="text-[10px] text-blue-400/60 mt-1 ml-6">
                  All material & transform changes included
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 mt-2">
                {['gltf', 'obj', 'stl'].map(format => (
                  <button 
                    ...
                    disabled={isExporting}
                    className="bg-gray-700/50 rounded p-2 text-xs hover:bg-gray-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed uppercase font-medium"
                  >
                    {format}
                  </button>
                ))}
